...
class Project(models.Model):
    ...
    gitlab_runner_count = fields.Integer(compute='_compute_gitlab_runner_count', string="Gitlab Runner Count")
    ...
    def action_gitlab_runners(self):
        ...
        return {
            ...
            'views': [
                (self.env.ref('gitlab_pipeline_trigger.gitlab_pipeline_runner_tree').id, 'tree'),
                (self.env.ref('gitlab_pipeline_trigger.gitlab_pipeline_runner_form').id, 'form'),
            ],
            'view_mode': 'tree,form',
